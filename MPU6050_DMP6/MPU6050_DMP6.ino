...
void setup() {
  ...
  pinMode(INDEX_FINGER, INPUT);
  pinMode(MIDDLE_FINGER, INPUT);
  pinMode(RING_FINGER, INPUT);
  pinMode(PINKY_FINGER, INPUT);
...
void loop() {
  ...
  if (mpu.dmpGetCurrentFIFOPacket(FIFOBuffer)) { // Get the Latest packet 
      ...
      index_val = digitalRead(INDEX_FINGER);
      middle_val = digitalRead(MIDDLE_FINGER);
      ring_val = digitalRead(RING_FINGER);
      pinky_val = digitalRead(PINKY_FINGER);
      ...
      Serial.print("\t");
      Serial.print(index_val != HIGH ? "1" : "0");
      Serial.print(middle_val != HIGH ? "1" : "0");
      Serial.print(ring_val != HIGH ? "1" : "0");
      Serial.println(pinky_val != HIGH ? "1" : "0");
    #endif
